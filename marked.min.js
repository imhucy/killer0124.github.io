...
!(function (e, u) {
    ...
    x = function (t, e) {
      ...
      var n = {
        replace: function (e, u) {
          return (
            (u = (u = u.source || u).replace(p, "$1")), (t = t.replace(e, u)), n
          );
        },
        getRegex: function () {
      ...
      return (
            ...
            var t = u[0],
              e = (function (e, u) {
                ...
                return u
                  ...
                  .map(function (e) {
                    var u = e.match(/^\s+/);
                    return null !== u && u[0].length >= t.length
                      ? e.slice(t.length)
                      : e;
                  })
                  .join("\n");
          ...
          if (e) {
            ...
            if (u.header.length === u.align.length) {
              ...
              for (t = u.cells.length, n = 0; n < t; n++)
                u.cells[n] = S(u.cells[n], u.header.length);
              return u;
            }
          }
        }),
              ...
              if (
                ...
                this.options.pedantic ||
                  ((s = u.match(
                    ...
                    ((t =
                      u.length - s.index + c.slice(f + 1).join("\n").length),
        ...
        (u.emStrong = function (e, u, t) {
          ...
          if (
            ...
            if (
              !r ||
              (r && ("" === t || this.rules.inline.punctuation.exec(t)))
            ) {
              var i,
                s = n[0].length - 1,
                l = s,
              ...
              for (
                D.lastIndex = 0, u = u.slice(-1 * e.length + s);
                null != (n = D.exec(u));
        ...
        (u.codespan = function (e) {
          ...
          if (u) {
            var t = u[2].replace(/\n/g, " "),
              ...
              e = /^ /.test(t) && / $/.test(t);
            return (
              n && e && (t = t.substring(1, t.length - 1)),
              (t = T(t, !0)),
              { type: "codespan", raw: u[0], text: t }
            );
          }
        }),
        (u.br = function (e) {
        ...
        (u.autolink = function (e, u) {
          ...
          if (e) {
            var t,
              u =
                "@" === e[2]
                  ? "mailto:" + (t = T(this.options.mangle ? u(e[1]) : e[1]))
                  : (t = T(e[1]));
            return {
              type: "link",
              raw: e[0],
        ...
        (u.url = function (e, u) {
          ...
          if ((t = this.rules.inline.url.exec(e))) {
            if ("@" === t[2])
              r = "mailto:" + (n = T(this.options.mangle ? u(t[0]) : t[0]));
            else {
              for (
                ;
                (i = t[0]),
  ...
  (q.punctuation = O(q.punctuation)
    ...
    (q.emStrong.lDelim = O(q.emStrong.lDelim)
      .replace(/punct/g, q._punctuation)
      .getRegex()),
    (q.emStrong.rDelimAst = O(q.emStrong.rDelimAst, "g")
      .replace(/punct/g, q._punctuation)
      .getRegex()),
    (q.emStrong.rDelimUnd = O(q.emStrong.rDelimUnd, "g")
      .replace(/punct/g, q._punctuation)
      .getRegex()),
    (q._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (q.reflinkSearch = O(q.reflinkSearch, "g")
  ...
  function N(e) {
    for (var u, t = "", n = e.length, r = 0; r < n; r++)
      (u = e.charCodeAt(r)),
        (t +=
          "&#" + (u = 0.5 < Math.random() ? "x" + u.toString(16) : u) + ";");
    return t;
  }
  var X = (function () {
      function t(e) {
        ...
        this.options.pedantic
          ...
          : this.options.gfm &&
            ((e.block = U.gfm),
            this.options.breaks ? (e.inline = P.breaks) : (e.inline = P.gfm)),
      ...
      return (
        ...
        (n.blockTokens = function (e, u, t) {
          ...
          for (
            ...
            if ((n = this.tokenizer.space(e)))
              (e = e.substring(n.raw.length)), n.type && u.push(n);
              ...
              (e = e.substring(n.raw.length)), u.push(n);
              ...
              (e = e.substring(n.raw.length)),
                (n.tokens = this.blockTokens(n.text, [], t)),
                u.push(n);
              ...
              (e = e.substring(n.raw.length)), u.push(n);
            else if (t && (n = this.tokenizer.paragraph(e)))
              (e = e.substring(n.raw.length)), u.push(n);
            ...
            switch ((i = e[l]).type) {
              ...
              case "table":
                for (
                  ...
                  (i.tokens.header[u] = []),
                    this.inlineTokens(i.header[u], i.tokens.header[u]);
                for (n = i.cells.length, u = 0; u < n; u++)
                  for (
                    r = i.cells[u], i.tokens.cells[u] = [], t = 0;
                    t < r.length;
                    t++
                  )
                    (i.tokens.cells[u][t] = []),
                      this.inlineTokens(r[t], i.tokens.cells[u][t]);
                break;
              case "blockquote":
                this.inline(i.tokens);
                break;
              case "list":
                for (n = i.items.length, u = 0; u < n; u++)
                  this.inline(i.items[u].tokens);
            }
          return e;
        }),
        (n.inlineTokens = function (e, u, t, n) {
          ...
          for (; e; )
            if ((s || (l = ""), (s = !1), (r = this.tokenizer.escape(e))))
              (e = e.substring(r.raw.length)), u.push(r);
              ...
              (e = e.substring(r.raw.length)),
                (r.tokens = this.inlineTokens(r.text, [], t, n)),
                u.push(r);
              ...
              (e = e.substring(r.raw.length)),
                (r.tokens = this.inlineTokens(r.text, [], t, n)),
                u.push(r);
            else if ((r = this.tokenizer.autolink(e, N)))
              (e = e.substring(r.raw.length)), u.push(r);
        ...
        (u.code = function (e, u, t) {
          ...
          return (
            !this.options.highlight ||
              (null != (u = this.options.highlight(e, n)) &&
                u !== e &&
                ((t = !0), (e = u))),
            (e = e.replace(/\n$/, "") + "\n"),
            n
      ...
      return (
        ...
        (u.getNextSafeSlug = function (e, u) {
          ...
          if (this.seen.hasOwnProperty(t))
            for (
              n = this.seen[e];
              (t = e + "-" + ++n), this.seen.hasOwnProperty(t);
              ...
              case "table":
                for (l = o = "", r = D.header.length, t = 0; t < r; t++)
                  l += this.renderer.tablecell(
                    this.parseInline(D.tokens.header[t]),
                    { header: !0, align: D.align[t] }
                  );
                for (
                  ...
                  for (
                    l = "", i = (s = D.tokens.cells[t]).length, n = 0;
                    n < i;
                    n++
                  )
  ...
  function ie(e, t, n) {
    ...
    try {
      ...
      if (
        ...
        return (
          "<p>An error occurred:</p><pre>" + ne(e.message + "", !0) + "</pre>"
        );
      throw e;
    }
  }
  return (
        ...
        (function () {
          ...
          for (e in l.renderer)
            !(function (r) {
              ...
              s[r] = function () {
                for (
                  var e = arguments.length, u = new Array(e), t = 0;
                  t < e;
                  t++
                )
                  u[t] = arguments[t];
    ...
    (ie.parseInline = function (e, u) {
      ...
      try {
        ...
        return (
          u.walkTokens && ie.walkTokens(t, u.walkTokens), ee.parseInline(t, u)
        );
      } catch (e) {
        if (
          ((e.message +=
